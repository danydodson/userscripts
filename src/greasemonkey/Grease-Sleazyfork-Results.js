// ==UserScript==
// @name         GreaseMonkey: Sleazyfork Results
...
// @match        https://www.greasyfork.org/*
// @match        https://sleazyfork.org/*
// @match        https://www.sleazyfork.org/*
// ==/UserScript==
  ...
  function addScore(script) {
    ...
    if (description) {
      ...
      description.innerHTML += `
        ...
        <div id="installation-instructions-modal-js" aria-hidden="true">
          <p class="installation-instructions-modal-content-bypass">
            <a href="#"></a>
          </p>
        </div>
        <div id="installation-instructions-modal-css" aria-hidden="true">
          <p class="installation-instructions-modal-content-bypass">
            <a href="#"></a>
          </p>
        </div>
