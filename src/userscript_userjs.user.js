...
(() => {
  ...
  //#region Console
  const err = (...msg) => {
    console.error('[%cUserJS%c] %cERROR', 'color: rgb(29, 155, 240);', '', 'color: rgb(249, 24, 128);', ...msg);
  };
  const info = (...msg) => {
    console.info('[%cUserJS%c] %cINF', 'color: rgb(29, 155, 240);', '', 'color: rgb(0, 186, 124);', ...msg);
  };
  const log = (...msg) => {
    console.log('[%cUserJS%c] %cLOG', 'color: rgb(29, 155, 240);', '', 'color: rgb(219, 160, 73);', ...msg);
  };
  //#endregion
  ...
  */
    ...
    constructor() {
      ...
      if (this.supported) {
        ...
        this.frame = make('iframe', 'mujs-iframe', {
          ...
          loading: 'lazy',
          src: 'about:blank',
          style: 'position: fixed;bottom: 1rem;right: 1rem;height: 525px;width: 90%;margin: 0px 1rem;z-index: 100000000000000020 !important;',
  ...
  const main = (injCon) => {
    try {
      ...
      makeTHead([
        { class: 'mujs-header-name', textContent: lang.name, },
