...
// @match           /^(https?:\/\/)(tmearn|additionalgamer|makemoneywithurl|shrinkearn|techcyan|aghtas|soltoshindo|link4m|kingsleynyc|healthy4pepole|kiktu|1bitspace|skip-url|pennbookcenter|publicananker|mikl4forex|michaelemad|miklpro|zirof|forex-golds|nawahi1|mosqam|semawur|forex-trnd|hoshilink|taiwancnan|bit-url|megurus|cuts-url|popimed|rayusmedya|enburl|pickhopes|toryxlink|aduzz|lycoslink|cdrab|ibrabucks|zenshort|ethiomi|shortenbuddy|kiemlua|smoner|djbhojpurisongs|urlty|sakastau|modsbase|ac.totsugeki|bcvc2|earnwithshortlink|bitzite|link1s|diadiemcheckin|tudiendanhngon|chooyomi|staaker)(\.com)(\/.*)/
// @match           /^(https?:\/\/)(lucidcam|forexlap|forexmab|linkjust|admediaflex|hoclamdaubep|rekonise|forex-articles|ponselharian|liinkat|thegoneapp|mobi2c|studyuo|hookeaudio|thehostingmentor|intlinki|linkshortify|shopsixseven|mohtawaa|msarzone|foodhear|fc-lc|expertvn|downphanmem|healdad|ez4mods|try2link|tmker|soft3arbi|techyadjectives|ex-foary|examtadka|bablyfeed|crypto4tun|)(\.com)(\/.*)/
// @match           /^(https?:\/\/)(sportsmediaz|big2short|techymozo|loptelink|2shrt|charexempire|coindoog|shotzon|novelsapps|webhostingpost|nightfallnews|tirailangit|intercelestial|tribuntekno|bestcash2020|hoxiin|fooot-map|priefy|dz-linkk|fauxlink|chinhnhacoban|autodime|cortaly|indianshortner|donia-tech|donia2tech|donia2link|short1s|cr3zyblog|btafile|pdiskshortener|urlsopen|1shortlink|linkerload|filenext|shrinkmoney|doodshort|paid4link|kienthucrangmieng|wiki-topia|aljoodm98|newworldnew|sahityt|mkomsel|niinga|bclikeqt|youssefsayed|fx4vip|shortzon|get4links|crickblaze|nostralink|clkmein|101desire|memangbau|hosting4lifetime|mesho-link|up4cash|newsharsh|examkhata|linksht|note1s|adclickersbot|mobitaak|btcwalk|99faucet|modebaca|paylinnk|olhonagrana|chedrive|teknosimple|discordserv|link-yz|apkadmin|ayelads|gawbne|mshortener|cutdomain|usersdrive|uptobox|1fichier|uploadrar|bayfiles|krakenfiles|post.copydev|icutlink|zegtrends|anonfiles|sharemods|ddownload|uppit|userscloud|newsnowbd|link.nulldown|asideway|url.namaidani|url.magmint|mp4upload|myshrinker|apkshrt|link.turkdown|drive.google|safe.intipanime|trylinko|uploadhaven|manga2day|shortyearn|workupload|filedm|themorningtribune|beingtek|sub2get|ex-load|campki|social-unlock|teerclub|short-jambo|link.bitmagge|nerdiess|best-cpm|clicksfly|megaupto|maqal360|foodboth|ufacw|techcartz|softechbharat|okrzone|informaxonline|shopdorod|blog-everything|sub2unlock|short.skalbayrak)(\.com)(\/.*)/
// @match           /^(https?:\/\/)(blogmado|itsguider|coin-free|1xfaucet|dash-free|usdshort|cafenau|techacode|ls2earn|sevenjournals|7misr4day|trflink|sama-pro|s.ume24|shtfly|bestmobilenew|onlineincoms|modsfire|adneow|short.clickscoin|samaa-pro|techrfour|ez4short|topnewsnew|gawishpro|dz4link|skincarie|gaminplay|infinitycoupon|videoslyrics|shortlite|wp.sekilastekno|bitefaucet|techrayzer|shorteet|donnaleehunt|puggygaming|link2end|tranquangchuan|blogginglass|1shorten|lensabicara|tieutietkiem|yummy-reciepes|doctor-groups|bioinflu|chamcuuhoc|litexblog|7nything|gamalk-sehetk|adsafelink|cbshort|bellurl|abcshort|checkscoin|llinkon|links.apksvip|nguyenvanbao|cloudgetlink|techloadz|atglinks|nulledsafe|dreamcheeky|cutpaid|fidlarmusic|rodjulian|anhdep24|money.alyoumeg|sl.claimfreebits|sl-1.btcbunch|sl-2.btcbunch|earncryptowrs|short-zero|insurancevela|zombiebtc|arahtekno|mopahealth|nghiencar|sl-3.btcbunch|apk.miuiku|apk.sekilastekno|bitlya|ecwizon|oncehelp|short.skalbayrak)(\.com)(\/.*)/
// @match           /^(https?:\/\/)(.+)?(zolomix|cararegistrasi|5golink|birdurls|snkra|artiskini|sh2rt|byboe|medcpu|nousdecor|restorbio|bdnewsx|upshrink|gifans|jardima|jobswd|gkqnaexam|imperialstudy|ovlinks|imagenesderopaparaperros|yofaurls|digiromotion|wingifta|rancah|coinadfly|delishwell|zippyshare|solidfiles|ourtecads|zubatecno|covemarkets|disheye|eda-ah|blog-forall|techymedies|gamelopte|allcryptotips|claimclicks|snowurl|riadcrypto|askpaccosi|linktrims|gets4link|visflakes|apk4do|dineroshare|elwatanelyoum|ledifha|claimfey|shrinkito|panylink|wrbloggers|tokenoto|saly-cash|upload-4ever|shortenn|admediaflex|btcpany|assettoworld|vikashmewada|linkyearn|appsbull|gam3ah|tinybc|diudemy|file-upload|shorterall|tribuncrypto|cempakajaya|safelinkduit|nadersoft7|adshorturl|linkbnao|phsensei|4shared|ta2deem7arbya|lrshortner|tinycmd|cloudshrinker|proviralhost|technicalatg|v2links|ytsubme|rainurl|arahlink|m4cut|i-polls|sonicbtc|cutln)(\.com)(\/.*)/
// @match           /^(https?:\/\/)(ahyblogs|ourcoincash|1manga|watchdoge|arenaboard|ccsl|shrinkpay|adsgo|shon|crypto-faucet|bingeflix|studystar|liongiv|lokagames|3vw|short-cash2|wizzly|mgnet|crypteen|dogeen|fauceteen|cutdl|sportawy|fexkomin|technemo|zoomcrypto|techboyz|cblinks|99links|kartunik|post.nites-tv|shortplus|stores.filmyzilla-in|expresscoins|claimcoinsfree|short1|swzz|acortame|alghtas|wizly|horanews|a1link|short2fly|bcvc|healthbloog|post.movies-near-me|st.kleaco|playlink|q8c|sh0rt1|cars-1year|nabits|welovecrypto|worldappsstore|0uq|sh.tripledownloader|short2url)(\.xyz)(\/.*)/
// @match           /^(https?:\/\/)(.+)?(senuansatechno|insurglobal|claimercorner|shortly|dexlink|doctorcoin|speedynews|1apple|ffworld|textpage|fidovy|egfly|insurance-space|crypto-blog|sapica|earnfacut|urlbharat|dropz|chainfo|megano-coin|techleets)(\.xyz)(\/.*)/
// @match           /^(https?:\/\/)(neonlink|techydino|illink|world-trips|yoshare|lets.5get|crypto-fi|wpcheap|coinmasterx|catcut|aztravels|dulichkhanhhoa|sub2unlock|forex-gold|techtrickonline|7apple|ccurl|luckydice|link1s|url.namaidani|cryptowidgets|dogeclick|adskip|hurirk|usfinf|xervoo|sport4you|hexupload|eloism|cutt|forexshare|blog.cryptowidgets|neexulro|dailyuploads|douploads|simfileshare|fir3|magybu|racaty|linegee|blogesque|thuocdangian|altblogger|letsboost|cut-y|megadb)(\.net)(\/.*)/
// @match           /^(https?:\/\/)(.+)?(digitalnaz|owllink|mozlink|cryptosats|rocklinks|celinks|jiotech|bitcomarket|fire-link|linkrex|urlw|paid4link|link3s|boscoin)(\.net)(\/.*)/
// @match           /^(https?:\/\/)(tnlink|jrlinks|qualitystudymaterial|cuturl|missionhight|wpking|zagl|ls2earn|streamshort|shareus|referus|megafly|megaurl|cutp|earnmoj|riadshot|urlmoney|cplink|cryptomonitor|technoflip|linkshortify|htlinks|techlearningtube|urlfly|linkocean|financeflix|uttan|jazbaat|djxmaza|bildirim|techy4you|battlechamp|sahilsumra|kerdlinfo|urlcut|insurancevlog|itechlogic|videolyrics|tekcrypt|du-link|moddingzone|adybrands|gpflix|gz2|dulink|aclinks)(\.in)(\/.*)/
// @match           /^(https?:\/\/)(.+)?(cashurl|linkad|bitcoinly|crazyblog|zolomix|technologylover|expertlinks|largestpanel|linkres|rsrlink|linkstream|xmod|short2url|99links|rplinks|enit|adloot|url2go|tnvalue|pvidly|apurl|earnspace|urlinked|mdlink|gamerfang|writedroid|teckypress|fixno)(\.in)(\/.*)?/
// @match           /^(https?:\/\/)(aylink|linkszia|mynewsmedia|gtlink|adfloz|linksly|droplink|123link|linksfy|adshorti|hxfile|dosya|veganal|takem|ezimg|eng.ezimg|dausel|9-animie|veganho|nulledmod|veganac)(\.co)(\/.*)/
// @match           /^(https?:\/\/)(.+)?(takez|linksfire|vosan|tinygo)(\.co)(\/.*)/
// @match           /^(https?:\/\/)(ctbl|girls-like|gobits|zoss|shrinke|tlin|terafly|petafly|gigafly|adnews|papanews|panyflay|mozzfly|shortus|short.croclix|best-news|mega-news|wildblog|specx|dddrive|linkpoi|sh24|m.newhit|mboost|linkshorts|exafly|nonofly|lozzfly|uptomega|stfly|adbull|youshort|health-and|cutx)(\.me)(\/.*)/
// @match           /^(https?:\/\/)(.+)?(theconomy|richlink)(\.me)(\/.*)/
// @match           /^(https?:\/\/)(sitr|flylink|downfile|savelink|linkshortify|shareus|promo-visits|mobileprice)(\.site)(\/.*)/
// @match           /^(https?:\/\/)(.+)?(cekip|link4rev|coin-city)(\.site)(\/.*)/
// @match           /^(https?:\/\/)(earnme|sanoybonito|automotur|kooza|1link|zentum|mytop5|forexwaw)(\.club)(\/.*)/
// @match           /^(https?:\/\/)(.+)?(usanewstoday|kadal|webhostingtips)(\.club)(\/.*)/
// @match           /^(https?:\/\/)(technicalramno1|paid4|yousm|coinpayz|tr|yocto|clk.dti|besturl|boostme|takefile)(\.link)(\/.*)/
// @match           /^(https?:\/\/)(.+)?(vshort|stex|cash4|zuba)(\.link)(\/.*)/
// @match           /^(https?:\/\/)(shurt|shortit|adsy|bitlinks|clik|playstore)(\.pw)(\/.*)/
// @match           /^(https?:\/\/)(.+)?(prz|pong)(\.pw)(\/.*)/
// @match           /^(https?:\/\/)(bloogerspoot|vsbl)(\.ga)(\/.*)/
// @match           /^(https?:\/\/)(bloogerspoot|linkshor)(\.tk)(\/.*)/
// @match           /^(https?:\/\/)(.+)?(madfaucet|mineshor|futureshor)(\.tk)(\/.*)/
// @match           /^(https?:\/\/)(bloogerspoot|urlchanger)(\.ml)(\/.*)/
// @match           /^(https?:\/\/)(onimports|link.encurtaon)(\.com\.br)(\/.*)/
// @match           /^(https?:\/\/)(mycut|exee|onlineteori|punyablog|activity|massive|caview)(\.my\.id)(\/.*)/
// @match           /^(https?:\/\/)(.+)?(apasih)(\.my\.id)(\/.*)/
// @match           /^(https?:\/\/)(.+)?(suratresmi|carapedi)(\.id)(\/.*)/
// @match           /^(https?:\/\/)(kiiw|passgen|wordcounter|shrink|revcot|clickzu|shortzu)(\.icu)(\/.*)/
// @match           /^(https?:\/\/)(newforex|wplink|nbyts|wealthystyle|clicksfly|happy-living|earn-cash|yourtechnology|apks|network-earn|teacherana|earnow|battleroyal)(\.online)(\/.*)/
// @match           /^(https?:\/\/)(.+)?(adslinkfly|readi)(\.online)(\/.*)/
// @match           /^(https?:\/\/)(exey|ezlinks|techmody|ouo|ex-e|saly|cuty|evoload|sh.swissfaucet|sl.swissfaucet|oke|letsupload|eio|oii)(\.io)(\/.*)/
// @match           /^(https?:\/\/)(.+)?(linkfly|usalink)(\.io)(\/.*)/
// @match           /^(https?:\/\/)(tny|tinyurl)(\.so)(\/.*)/
// @match           /^(https?:\/\/)(zshort|claimcrypto|cashearn|1ink|linkpay|moneylink|intnews|openload|linkspy|letsupload)(\.cc)(\/.*)/
// @match           /^(https?:\/\/)(cryptoad|wikile|uploadev|mega4up|doibihar|cshort|payskip|homeairquality)(\.org)(\/.*)/
// @match           /^(https?:\/\/)(.+)?(medipost|shrinkurl|keeplinks|rajdlsg)(\.org)(\/.*)/
// @match           /^(https?:\/\/)(jameeltips|mitly|adfoc|link4fun)(\.us)(\/.*)/
// @match           /^(https?:\/\/)(.+)?(yalla-shoot-now|forexeen)(\.us)(\/.*)/
// @match           /^(https?:\/\/)(noweconomy|deportealdia|adshort|ay|pngit|pndx)(\.live)(\/.*)/
// @match           /^(https?:\/\/)(earnads|genpassword|shrlink|mshort|punyamerk|shortnow|short.freeltc)(\.top)(\/.*)/
// @match           /^(https?:\/\/)(zagl|scratch247|siyn|portablesusb|children-learningreading|azmath|mobilereview|inform3tion|mobilism|machicon-akihabara|cooklike|videoclip|bitcrypto|shortlinkto|uptobhai|brbushare|fanclup)(\.info)(\/.*)/
// @match           /^(https?:\/\/)(faucetcrypto|bildirim)(\.eu)(\/.*)/
// @match           /^(https?:\/\/)(nex-url|olamovies|atrologyrex)(\.cyou)(\/.*)/
// @match           /^(https?:\/\/)(antonimos|blog.hostratgeber)(\.de)(\/.*)/
// @match           /^(https?:\/\/)(freelitecoin|uplinkto)(\.vip)(\/.*)/
// @match           /^(https?:\/\/)(.+)?(flyad|lootcash)(\.vip)(\/.*)/
// @match           /^(https?:\/\/)(romania|met)(\.bz)(\/.*)/
// @match           /^(https?:\/\/)(adshrink|cutin)(\.it)(\/.*)/
// @match           /^(https?:\/\/)(pingit|files)(\.im)(\/.*)/
// @match           /^(https?:\/\/)(clk|9xupload)(\.asia)(\/.*)/
// @match           /^(https?:\/\/)(iir|tei|ier|ckk)(\.ai)(\/.*)/
// @match           /^(https?:\/\/)(aii|clk|oko)(\.sh)(\/.*)/
// @match           /^(https?:\/\/)(.+)?(i8l|clk)(\.ink)(\/.*)/
// @match           /^(https?:\/\/)(.+)?(upload|prx)(\.ee)(\/.*)/
// @match           /^(https?:\/\/)(.+)?(mirrored|clicknupload)(\.to)(\/.*)/
// @match           /^(https?:\/\/)(.+)?(ouo|forextrader|daga88)(\.today)(\/.*)/
// @match           /^(https?:\/\/)(.+)?(techgeek|adsgo)(\.digital)(\/.*)/
// @match           /^(https?:\/\/)(mhma12|surflink|techtrim)(\.tech)(\/.*)/
// @match           /^(https?:\/\/)(kiw|redir.123file)(\.li)(\/.*)/
// @match           /^(https?:\/\/)(zonearn|theprice|nhacremix|doanvanhai)(\.biz)(\/.*)/
// @match           /^(https?:\/\/)(.+)?(123link)(\.biz)(\/.*)/
// @match           /^(https?:\/\/)(.+)?(exe|exee|exep|upfiles)(\.app)(\/.*)/
// @match           /^(https?:\/\/)(adshort|1bit|2the|careerhunter)(\.space)(\/.*)/
// @match           /^(https?:\/\/)(makeeasybtc|softindex|techus)(\.website)(\/.*)/
// @match           /^(https?:\/\/)(linka|xtrabits)(\.click)(\/.*)/
// @match           /^(https?:\/\/)(.+)?(shortlinks|easysl|adlink|adzilla|urlcash)(\.click)(\/.*)/
// @match           /^(https?:\/\/)(.+)?(hamody|nathanaeldan|freddyoctavio|davisonbarker|clks|cryptosh)(\.pro)(\/.*)/
// @match           /^(https?:\/\/)(up-load|zcash)(\.one)(\/.*)/
// @match           /^(https?:\/\/)(1dogecoin|faucet)(\.work)(\/.*)/
// @match           /^(https?:\/\/)(sh.feyorra|fey.feyorra|claim|surelink|chuksblog|superlink)(\.fun)(\/.*)/
// @match           /^(https?:\/\/)(go|blog|go2|tech|test|blg)(\.madshiba\.fun)(\/.*)/
// @match           /^(https?:\/\/)(linkati|zenshort|curto|sh.kiddypay)(\.win)(\/.*)/
// @match           /^(https?:\/\/)(cool-time|movies|anime|tech)(\.dutchycorp\.space)(\/.*)/
// @match           /^https:\/\/linkvertise\.com\/(1|2|3|4|5|6|7|8|9)/
// @match           /^https:\/\/cryptofans\.club\/(short|next|other|step)/
// @match           /^(https?:\/\/)(.+)?(mediafire)(\.com)\/(download|file)/
// @match           /^(https?:\/\/)(.+)?(cryptocurrencytracker|freefaucet)(\.biz)\/(link)/
// @match           /^(https?:\/\/)(.+)?(freebitcoin)(\.fun)\/(topsites|view)/
// @match           /^https:\/\/claimclicks\.com\/(btc|ltc|doge|trx|faucetlist|ptclist)/
// @match           /^(https?:\/\/)(.+)?(clickscoin|freefeyorra|reddcoineveryday|cryptotyphoon|softairbay)(\.com)\/(short)/
// @match           /^https:\/\/claimercorner\.xyz\/(claimer\/dashboard|claimer\/advertise|claimer\/ptc|claimer\/deposit|claimer\/transfer|claimer\/tasks|claimer\/offerwall|claimer\/profile|claimer\/auto|claimer\/mining|claimer\/wheel|claimer\/login)/
// @match           /^https:\/\/cryptosats\.net\/(cryptosats\/dashboard|cryptosats\/advertise|cryptosats\/ptc|cryptosats\/deposit|cryptosats\/transfer|cryptosats\/tasks|cryptosats\/offerwall|cryptosats\/profile|cryptosats\/auto|cryptosats\/mining|cryptosats\/wheel|cryptosats\/login)/
// @match           /^https:\/\/99faucet|faucet.cempakajaya\.com\/(dashboard|advertise|ptc|deposit|transfer|tasks|offerwall|profile|auto|mining|dice|lottery|faucet|login)/
// @match           /^https:\/\/free.tribuncrypto\.com\/(dashboard|advertise|ptc|deposit|transfer|tasks|offerwall|profile|auto|mining|dice|lottery|faucet|login)/
// @match           *://*.vosan.co/
...
(function () {
  ...
  })(new URL(location.href)); if (sl) { location.href = sl }
  BypassedByBloggerPemula(/adbtc.top/, function () {
    let count = 0; setInterval(function () { if (bp("div.col.s4> a") && !bp("div.col.s4> a").className.includes("hide")) { count = 0; bp("div.col.s4> a").click() } else { count = count + 1 } }, 5000)
  ...
  if (['interactive', 'complete'].includes(document.readyState)) { onHtmlLoaded() } else { document.addEventListener('DOMContentLoaded', onHtmlLoaded) } function onHtmlLoaded() {
    if (['bas.nurul-huda.or.id', 'rotator.nurul-huda.sch.id'].indexOf(location.host) > -1) { } else {
      const listhide = document.querySelectorAll('#frame,.adb,#iframe,#particles-js,#canvas,.floawing-banner,#orquidea-slideup,.floating-banner,#wcfloatDiv4,#preloader,.vanta-canvas,.particles-js-canvas-el,#s65c,#ofc9,#overlay,#footerads,#d7b2,#_m_a_,#masthead_,.oulcsy,.sticky-bottom,.sticky-bottom1,.sticky-bottom2,.sticky-bottom3,.bElNbEFRL3JvbG89,.separator,html body iframe,html iframe,#cookie-pop,.vmyor,.tnjmvneldp,.full_post_area.rh-container,.sc-content-aside,#ofc9,.floawing-banner,div.demand-supply,.the_content')
    ...
    if (['nightfallnews.com', 'fc-lc.com', 'chooyomi.com', 'paid4.link', 'usersdrive.com', 'zentum.club', 'patak.dropz.xyz', 'my.dropz.xyz', 'workupload.com', 'taiwancnan.com', 'solarchaine.com', 'shortit.pw', 'djxmaza.in'].indexOf(location.host) > -1) { window.top != window.self } else { clickIfElementExists('button.btn:nth-child(4)', 2, 'setInterval') }
    if (['bitlinks.pw', 'ayelads.com', 'apkadmin.com', 'cashearn.cc', 'rancah.com', 'digitalnaz.net', 'upload-4ever.com', 'hexupload.net', 'upfiles.app', 'keeplinks.org', 'fileshare.adshorturl.com', 'bowfile.com', 'letsupload.io', 'workupload.com'].includes(window.location.hostname) > -1) { } else { if (elementExists('div.col-md-4:nth-child(2)')) { setInterval(function () { bp('div.col-md-4:nth-child(2) > span:nth-child(1) > img:nth-child(1)').click() }, 5000) } }
    ...
    if (['short.croclix.me', 'www.adz7short.space'].indexOf(location.host) > -1) {
    ...
    if (location.host === 'upfiles.app') { clickIfElementExists('.get-link.btn-download.btn-primary.btn', 13) } else if (location.host === 'rodjulian.com') { clickIfElementExists('a.btn.btn-primary.btn-lg.get-link', 5, 'setInterval') } else if (location.href.indexOf("ay.live") != -1 || location.href.indexOf("aylink.co") != -1) {
      var form = $('#go-link')
      ...
      $("#go-link").unbind().submit(function (e) {
        e.preventDefault(); var form = $(this); var url = form.attr('action'); const pesan = form.find('button'); const notforsale = $(".navbar-collapse.collapse"); const blogger = $(".main-header"); const pemula = $(".col-sm-6.hidden-xs")
        $.ajax({
    ...
    const bas = (h => {
      ...
      switch (h.host) {
        case 'bas.nurul-huda.or.id': case 'rotator.nurul-huda.sch.id': if (h.pathname === '/' && h.searchParams.has('url') && h.searchParams.has('sn')) {
          ...
          window.location.assign('https://softindex.website' + (location.search).substring(27))
    ...
    let apiBypassVip = {
      selectors: ['#stepid', '.locked', '#steps', '#link', '#targetbtn', '#theLinkID', '.locked-button'],
    ...
    BloggerPemula('kienthucrangmieng.com|coindoog.com|tieutietkiem.com|askpaccosi.com|shopsixseven.com|hoclamdaubep.com|thuocdangian.net|chinhnhacoban.com|coin-free.com|fanclup.info|chamcuuhoc.com|nhacremix.biz|doanvanhai.biz', 'wpsafelink', '', false)
    ...
    BypassedByBloggerPemula(/largestpanel.in/, function () { clickIfElementExists('#tp-snp2', 1) })
    ...
    BypassedByBloggerPemula(/chooyomi.com/, () => waitForElm(".get-link > a:nth-child(1)", cho => redirect(cho.href)))
    ...
    BypassedByBloggerPemula(/altblogger.net/, () => { waitForElm('#form', () => { bp('#form').submit(); bp('#surl').click() }) })
    ...
    BypassedByBloggerPemula(/btcpany.com|zombiebtc.com|blog.zubatecno.com|news.claimfey.com/, function () { bp('#link1s-form').submit() })
