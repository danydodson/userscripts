...
(function() {
  ...
  GM_addStyle(`#medium-bypass-tool img {  width: 100%;
  aspect-ratio: 1;
  border-radius: 50%;
}
#medium-bypass-tool button {
  background: none;
  border: none;
  padding: 0;
  margin: 0;
...
#medium-bypass-tool button:hover {
