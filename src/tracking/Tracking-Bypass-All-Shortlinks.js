...
// @include           https://dutchycorp.space/s*/*
// @include           https://dutchycorp.ovh/s*/*
// @include           https://shorts.lu/*
// @include           https://al.ly/*
// @include           https://za.uy/*
// @include           https://za.gl/*
// @include           https://goo.st/*
// @include           https://c2g.at/*
// @include           https://fcc.lc/*
// @include           https://2ad.ir/*
// @include           https://coin.mg/*
// @include           https://send.cm/*
// @include           https://kimo.ma/*
// @include           https://goads.ly/*
// @include           https://mdn.rest/*
// @include           https://*.mdn.lol/*
// @include           https://*.rota.cc/*
// @include           https://ouo.press/*
// @include           https://*.flyzu.icu/*
// @include           https://tinyurl.is/*
// @include           https://*.mdn.world/*
// @include           https://nail.edu.pl/*
// @include           https://lolabits.se/*
// @include           https://z-cash.xyz/ad/*
// @include           https://drop.download/*
// @include           https://cryptofuns.ru/*
// @include           https://gosixs.com/s/*
// @include           https://linkshrink.ca/*
// @include           https://short.express/*
// @include           https://arbweb.info/sl/*
// @include           https://*.cizgifilm.tv/*
// @include           https://faucethub.ly/hs/*
// @include           https://faucetpay.io/ptc*
// @include           https://*.trangchu.news/*
// @include           https://webmobile.store/*
// @include           https://*.adz7short.space/*
// @include           https://docs.google.com/uc*
// @include           https://starfaucet.net/sl/*
// @include           https://solarchaine.com/sl/*
// @include           https://shrt.cryptofuns.ru/*
// @include           https://iqfaucet.com/link3/*
// @include           https://horrorbitcoin.com/?*
// @include           https://satoshi-win.xyz/url/*
// @include           https://cryptonetos.ru/page/*
// @include           https://faucet.gold/BTC/?step*
// @include           https://faucet.gold/ETH/?step*
// @include           https://adbtc.top/surf/browse/*
// @include           https://anonym.ninja/download/*
// @include           https://claimsolana.xyz/short/*
// @include           https://faucetcrypto.net/short/*
// @include           https://stationbit.xyz/autolink/*
// @include           https://cryptoaffiliates.store/sh*
// @include           https://konstantinova.net/verify/*
// @include           https://playnano.online/watch-and*
// @include           https://adbtc.top/surfiat/browse/*
// @include           https://rotator.nurul-huda.sch.id/*
// @include           https://*api-secure.solvemedia.com/*
// @include           https://faucetcrypto.com/claim/step/*
// @include           https://linkvertise.download/download/*
// @include           https://*.racedepartment.com/downloads/*
// @include           https://cryptorotator.website/sh_live/*
// @include           https://cryptonetos.ru/page/redirect*
// @include           https://galerybits.com/protectlink/*
// @include           https://earnultimate.space/short/*
// @include           https://bas.nurul-huda.or.id/*
...
// @--include           /^(https?:\/\/)(.+)?(senuansatechno|insurglobal|claimercorner|shortly|dexlink|doctorcoin|speedynews|1apple|ffworld|textpage|fidovy|egfly|insurance-space|crypto-blog|sapica|earnfacut|urlbharat|dropz|chainfo|megano-coin|techleets)(\.xyz)(\/.*)/
// @--include           /^(https?:\/\/)(neonlink|techydino|illink|world-trips|yoshare|lets.5get|crypto-fi|wpcheap|coinmasterx|catcut|aztravels|dulichkhanhhoa|sub2unlock|forex-gold|techtrickonline|7apple|ccurl|luckydice|link1s|url.namaidani|cryptowidgets|dogeclick|adskip|hurirk|usfinf|xervoo|sport4you|hexupload|eloism|cutt|forexshare|blog.cryptowidgets|neexulro|dailyuploads|douploads|simfileshare|fir3|magybu|racaty|linegee|blogesque|thuocdangian|altblogger|letsboost|cut-y|megadb)(\.net)(\/.*)/
// @--include           /^(https?:\/\/)(.+)?(digitalnaz|owllink|mozlink|cryptosats|rocklinks|celinks|jiotech|bitcomarket|fire-link|linkrex|urlw|paid4link|link3s|boscoin)(\.net)(\/.*)/
...
// @include           /^(https?:\/\/)(.+)?(cashurl|linkad|bitcoinly|crazyblog|zolomix|technologylover|expertlinks|largestpanel|linkres|rsrlink|linkstream|xmod|short2url|99links|rplinks|enit|adloot|url2go|tnvalue|pvidly|apurl|earnspace|urlinked|mdlink|gamerfang|writedroid|teckypress|fixno)(\.in)(\/.*)?/
// @include           /^(https?:\/\/)(aylink|linkszia|mynewsmedia|gtlink|adfloz|linksly|droplink|123link|linksfy|adshorti|hxfile|dosya|veganal|takem|ezimg|eng.ezimg|dausel|9-animie|veganho|nulledmod|veganac)(\.co)(\/.*)/
// @include           /^(https?:\/\/)(.+)?(takez|linksfire|vosan|tinygo)(\.co)(\/.*)/
// @include           /^(https?:\/\/)(ctbl|girls-like|gobits|zoss|shrinke|tlin|terafly|petafly|gigafly|adnews|papanews|panyflay|mozzfly|shortus|short.croclix|best-news|mega-news|wildblog|specx|dddrive|linkpoi|sh24|m.newhit|mboost|linkshorts|exafly|nonofly|lozzfly|uptomega|stfly|adbull|youshort|health-and|cutx)(\.me)(\/.*)/
// @include           /^(https?:\/\/)(.+)?(theconomy|richlink)(\.me)(\/.*)/
// @include           /^(https?:\/\/)(sitr|flylink|downfile|savelink|linkshortify|shareus|promo-visits|mobileprice)(\.site)(\/.*)/
// @include           /^(https?:\/\/)(.+)?(cekip|link4rev|coin-city)(\.site)(\/.*)/
// @include           /^(https?:\/\/)(earnme|sanoybonito|automotur|kooza|1link|zentum|mytop5|forexwaw)(\.club)(\/.*)/
// @include           /^(https?:\/\/)(.+)?(usanewstoday|kadal|webhostingtips)(\.club)(\/.*)/
// @include           /^(https?:\/\/)(technicalramno1|paid4|yousm|coinpayz|tr|yocto|clk.dti|besturl|boostme|takefile)(\.link)(\/.*)/
...
// @include           /^(https?:\/\/)(bloogerspoot|linkshor)(\.tk)(\/.*)/
// @include           /^(https?:\/\/)(.+)?(madfaucet|mineshor|futureshor)(\.tk)(\/.*)/
// @include           /^(https?:\/\/)(bloogerspoot|urlchanger)(\.ml)(\/.*)/
// @include           /^(https?:\/\/)(onimports|link.encurtaon)(\.com\.br)(\/.*)/
// @include           /^(https?:\/\/)(mycut|exee|onlineteori|punyablog|activity|massive|caview)(\.my\.id)(\/.*)/
...
// @include           /^(https?:\/\/)(exey|ezlinks|techmody|ouo|ex-e|saly|cuty|evoload|sh.swissfaucet|sl.swissfaucet|oke|letsupload|eio|oii)(\.io)(\/.*)/
// @include           /^(https?:\/\/)(.+)?(linkfly|usalink)(\.io)(\/.*)/
// @include           /^(https?:\/\/)(tny|tinyurl)(\.so)(\/.*)/
// @include           /^(https?:\/\/)(zshort|claimcrypto|cashearn|1ink|linkpay|moneylink|intnews|openload|linkspy|letsupload)(\.cc)(\/.*)/
// @include           /^(https?:\/\/)(cryptoad|wikile|uploadev|mega4up|doibihar|cshort|payskip|homeairquality)(\.org)(\/.*)/
...
// @include           /^(https?:\/\/)(freelitecoin|uplinkto)(\.vip)(\/.*)/
...
// @include           /^(https?:\/\/)(zonearn|theprice|nhacremix|doanvanhai)(\.biz)(\/.*)/
// @include           /^(https?:\/\/)(.+)?(123link)(\.biz)(\/.*)/
// @include           /^(https?:\/\/)(.+)?(exe|exee|exep|upfiles)(\.app)(\/.*)/
// @include           /^(https?:\/\/)(adshort|1bit|2the|careerhunter)(\.space)(\/.*)/
// @include           /^(https?:\/\/)(makeeasybtc|softindex|techus)(\.website)(\/.*)/
// @include           /^(https?:\/\/)(linka|xtrabits)(\.click)(\/.*)/
// @include           /^(https?:\/\/)(.+)?(shortlinks|easysl|adlink|adzilla|urlcash)(\.click)(\/.*)/
// @include           /^(https?:\/\/)(.+)?(hamody|nathanaeldan|freddyoctavio|davisonbarker|clks|cryptosh)(\.pro)(\/.*)/
// @include           /^(https?:\/\/)(up-load|zcash)(\.one)(\/.*)/
// @include           /^(https?:\/\/)(1dogecoin|faucet)(\.work)(\/.*)/
// @include           /^(https?:\/\/)(sh.feyorra|fey.feyorra|claim|surelink|chuksblog|superlink)(\.fun)(\/.*)/
// @include           /^(https?:\/\/)(go|blog|go2|tech|test|blg)(\.madshiba\.fun)(\/.*)/
// @include           /^(https?:\/\/)(linkati|zenshort|curto|sh.kiddypay)(\.win)(\/.*)/
...
// @include           /^https:\/\/claimclicks\.com\/(btc|ltc|doge|trx|faucetlist|ptclist)/
// @include           /^(https?:\/\/)(.+)?(clickscoin|freefeyorra|reddcoineveryday|cryptotyphoon|softairbay)(\.com)\/(short)/
// @include           /^https:\/\/claimercorner\.xyz\/(claimer\/dashboard|claimer\/advertise|claimer\/ptc|claimer\/deposit|claimer\/transfer|claimer\/tasks|claimer\/offerwall|claimer\/profile|claimer\/auto|claimer\/mining|claimer\/wheel|claimer\/login)/
// @include           /^https:\/\/cryptosats\.net\/(cryptosats\/dashboard|cryptosats\/advertise|cryptosats\/ptc|cryptosats\/deposit|cryptosats\/transfer|cryptosats\/tasks|cryptosats\/offerwall|cryptosats\/profile|cryptosats\/auto|cryptosats\/mining|cryptosats\/wheel|cryptosats\/login)/
// @include           /^https:\/\/99faucet|faucet.cempakajaya\.com\/(dashboard|advertise|ptc|deposit|transfer|tasks|offerwall|profile|auto|mining|dice|lottery|faucet|login)/
// @include           /^https:\/\/free.tribuncrypto\.com\/(dashboard|advertise|ptc|deposit|transfer|tasks|offerwall|profile|auto|mining|dice|lottery|faucet|login)/
