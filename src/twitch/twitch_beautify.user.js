...
(function () {
  const d = function (a) {
    ...
    b = {
      ja: {
        MS_01: "🛠️ ビューティファイが無効です❌",
        MS_02: "🛠️ ビューティファイが有効です✅"
      },
      ko: {
        MS_01: "🛠️ 뷰티파이 비활성화됨❌",
        MS_02: "🛠️ 뷰티파이 활성화됨✅"
      ...
      "en-US": {
        MS_01: "🛠️ Beautification disabled❌",
        MS_02: "🛠️ Beautification enabled✅"
      },
      "zh-CN": b,
      "zh-SG": b,
      "zh-TW": c,
  ...
  (new class {
    ...
    async Fun(a, b = !0) {
      if (0 < a.length) {
        if (b) {
          const isTheatreMode = document.querySelector('[data-a-player-state="theatre"]') !== null;
          a.draggable({
        cursor: "grabbing",
