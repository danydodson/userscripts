...
[![Repo Stars](https://img.shields.io/github/stars/danydodson/userscripts?style=flat)](https://github.com/danydodson/userscripts)
[![Forks](https://img.shields.io/github/forks/danydodson/userscripts?style=flat-square)](https://github.com/danydodson/userscripts)
[![Last Commit](https://img.shields.io/github/last-commit/danydodson/userscripts?style=flat-square)](https://github.com/danydodson/userscripts/commits/main)
[![Top Language](https://img.shields.io/github/languages/top/danydodson/userscripts?style=flat-square)](https://github.com/danydodson/userscripts)
[![GitHub License](https://img.shields.io/github/license/danydodson/userscripts?style=flat-square)](https://opensource.org/licenses/MIT)
...
| discord-toggle-channels | [discord-toggle-channels.user.js](./src/discord-toggle-channels.user.js) | Removes the channels sidebar for more screen space. |
| discord-toggle-servers | [discord-toggle-servers.user.js](./src/discord-toggle-servers.user.js) | Removes the servers sidebar for more screen space. |
...
| greasyfork-copy-code | [greasyfork-copy-code.user.js](./src/greasyfork-copy-code.user.js) | Adds a copy code button to the greasyfork code page. |
| greasyfork-other-sites | [greasyfork-other-sites.user.js](./src/greasyfork-other-sites.user.js) | Add search option to search on userscripts.org, openuserjs.org, monkeyguts.com, google.com and google custom search. |
| greasyfork-plus | [greasyfork-plus.user.js](./src/greasyfork-plus.user.js) | Adds various features and improves the greasyfork experience. |
| greasyfork-total-installs | [greasyfork-total-installs.user.js](./src/greasyfork-total-installs.user.js) | A userscript that shows the total installs for any page on greasyfork. |
| greasyfork-utility-toolkit | [greasyfork-utility-toolkit.user.js](./src/greasyfork-utility-toolkit.user.js) | Various features for greasyfork, including absolute time, widescreen web pages, script page enhancements, download extensions, panel fixes, and more. |
| gw2-copy-api-id | [gw2-copy-api-id.user.js](./src/gw2-copy-api-id.user.js) | Adds a button to copy API ID code of items, skills, traits on wiki.guildwars2.com. |
...
| media-always-new-window | [media-always-new-window.user.js](./src/media-always-new-window.user.js) | Force every single link to open in a new window/tab. |
| media-h5-player | [media-h5-player.user.js](./src/media-h5-player.user.js) | Audio and video enhancement script. |
| media-hide-mouse | [media-hide-mouse.user.js](./src/media-hide-mouse.user.js) | Hides the mouse pointer immediately after it stops moving. |
| media-hide-scrollbars | [media-hide-scrollbars.user.js](./src/media-hide-scrollbars.user.js) | Hides all Scrollbars. |
| media-m3u8-detector | [media-m3u8-detector.user.js](./src/media-m3u8-detector.user.js) | Automatically detect the m3u8 video of the page and download it completely. |
